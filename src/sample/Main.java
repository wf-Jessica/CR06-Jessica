...
public class Main
    ...
    public void  start(Stage primaryStage) {
        ...
        primaryStage.setTitle( "School Statistic of Teachers");
    ...
    private   class  ListSelectChangeListener implements  ChangeListener<Number> {
        ...
        public   void  changed(ObservableValue<? extends Number> ov,
            ...
            teacher todo = data.get(new_val.intValue());
            nametxt.setText(todo.getName());
            desctxt.setText(todo.getSurname());
    ...
    private   class  NewButtonListener implements  EventHandler<ActionEvent> {
        ...
        public   void  handle(ActionEvent e) {
            ...
            teacher todo = new teacher( 0 , "NEW Todo" , "",""); // 0 = dummy id
            int  ix = 0 ;
            data.add(ix, todo);
    ...
    private   boolean  isNameAlreadyInDb(teacher todo) {
    ...
    private   class  DeleteButtonListener implements  EventHandler<ActionEvent> {
        ...
        public   void  handle(ActionEvent ae) {
            ...
            teacher itemSelected = data.get(ix);
            nametxt.setText(itemSelected.getName());
            desctxt.setText(itemSelected.getSurname());
            listView.requestFocus();
        }
    }
